...
热钱包提现请求
`POST /wallet/transfer/{coin_type}{from}{to}{quantity}{memo}`
...
热钱包提现请求
`POST /wallet/transfer/{coin_type}{from}{to}{quantity}{memo}`
#### `POST /wallet/transfer/{coin_type}{from}{to}{quantity}{memo}`  热钱包提现请求

* URL 

`{{TEST_URL}}/wallet/transfer/{coin_type}{from}{to}{quantity}{memo}`

let signStr = "POST|/wallet/transfer|"+"EOS|vbuspyjtst3p|kpd1uhb1ulsj|0.0001|"
...
5、 String sign = byteToStr(signBytes)
6、在请求头里面设置 'x-sign':sign
