...
热钱包提现请求
`POST /wallet/transfer/{coin_type}{to}{quantity}{memo}{sign}`
#### `POST /wallet/transfer/{coin_type}{to}{quantity}{memo}{sign}`  热钱包提现请求

* URL 

`{{TEST_URL}}/wallet/transfer/{coin_type}{to}{quantity}{memo}`

let signStr = "POST|/wallet/transfer|"+"EOS|kpd1uhb1ulsj|0.0001|"
